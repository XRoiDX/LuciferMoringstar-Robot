...
# # ---------- 🔘 [ | 𝗚𝗥𝗢𝗨𝗣 𝗙𝗜𝗟𝗧𝗘𝗥𝗦 | ] 🔘 ---------- # #
        ...
        if query.data.startswith("nextgroup"):
            ...
            if int(index) == int(data["total"]) - 2:
                ...
                buttons.append(
                    [InlineKeyboardButton("🔙 𝗕𝗔𝗖𝗞 𝗣𝗔𝗚𝗘 🔙", callback_data=f"backgroup_{int(index)+1}_{keyword}")]
                )
                buttons.append(
                    [InlineKeyboardButton(f"📃 𝗣𝗮𝗴𝗲𝘀 {int(index)+2}/{data['total']}", callback_data="pages"),
                     InlineKeyboardButton("𝗖𝗹𝗼𝘀𝗲 🗑️", callback_data="close")]
                )
                buttons.append(
                    [InlineKeyboardButton(text="🤖 𝗖𝗵𝗲𝗰𝗸 𝗠𝘆 𝗣𝗠 🤖", url=f"https://telegram.dog/{bot_info.BOT_USERNAME}")]
                )
                ...
                buttons.append(
                    [InlineKeyboardButton("🔙 𝗕𝗔𝗖𝗞 𝗣𝗔𝗚𝗘 🔙", callback_data=f"backgroup_{int(index)+1}_{keyword}"),InlineKeyboardButton("Next Page ➡", callback_data=f"nextgroup_{int(index)+1}_{keyword}")]
                )
                buttons.append(
                    [InlineKeyboardButton(f"📃 𝗣𝗮𝗴𝗲𝘀 {int(index)+2}/{data['total']}", callback_data="pages"),
                     InlineKeyboardButton("𝗖𝗹𝗼𝘀𝗲 🗑️", callback_data="close")]
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [InlineKeyboardButton("𝗡𝗲𝘅𝘁 𝗣𝗮𝗴𝗲 ➡", callback_data=f"nextgroup_{int(index)-1}_{keyword}")]
                )
                buttons.append(
...
# # ---------- 🔘 [ | 𝗕𝗢𝗧 𝗣𝗠 𝗙𝗜𝗟𝗧𝗘𝗥𝗦 | ] 🔘 ---------- # #
            ...
            if int(index) == int(data["total"]) - 2:
                ...
                buttons.append(
                    [InlineKeyboardButton("🔙 𝗕𝗔𝗖𝗞 𝗣𝗔𝗚𝗘 🔙", callback_data=f"backbot_{int(index)+1}_{keyword}")]
                )
                buttons.append(
                    [InlineKeyboardButton(f"📃 𝗣𝗮𝗴𝗲𝘀 {int(index)+2}/{data['total']}", callback_data="pages"),
                     InlineKeyboardButton("𝗖𝗹𝗼𝘀𝗲 🗑️", callback_data="close")]
                ...
                buttons.append(
                    [InlineKeyboardButton("🔙 𝗕𝗔𝗖𝗞 𝗣𝗔𝗚𝗘 🔙", callback_data=f"backbot_{int(index)+1}_{keyword}"),InlineKeyboardButton("Next Page ➡", callback_data=f"nextbot_{int(index)+1}_{keyword}")]
                )
                buttons.append(
                    [InlineKeyboardButton(f"📃 𝗣𝗮𝗴𝗲𝘀 {int(index)+2}/{data['total']}", callback_data="pages"),
                     InlineKeyboardButton("𝗖𝗹𝗼𝘀𝗲 🗑️", callback_data="close")]
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [InlineKeyboardButton("𝗡𝗲𝘅𝘁 𝗣𝗮𝗴𝗲 ➡", callback_data=f"nextbot_{int(index)-1}_{keyword}")]
                )
                buttons.append(
                    [InlineKeyboardButton(f"📃 𝗣𝗮𝗴𝗲𝘀 {int(index)}/{data['total']}", callback_data="pages"),
                     InlineKeyboardButton("𝗖𝗹𝗼𝘀𝗲 🗑️", callback_data="close")]
...
# ---------- 📁 [ | 𝗣𝗠 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            for files in filedetails:
                ...
                buttons = [[
                  InlineKeyboardButton('🎥 Mʟᴍ Nᴇᴡ M๏ᴠɪᴇs', url='https://t.me/+jMPx7Mm5W5piZTZl')
                  ]]                 
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton(text="✨ ꜱᴇᴀʀᴄʜ ᴍy ɪɴʟɪɴᴇ ✨️", switch_inline_query_current_chat="",),
                 ],[
                 InlineKeyboardButton("ℹ️ ʜᴇʟᴩ", callback_data="help"),
                 InlineKeyboardButton("😎 ᴀʙᴏᴜᴛ", callback_data="about") 
                 ],[
                 InlineKeyboardButton("🗳 ʙᴏᴛꜱ ꜱᴜᴩᴩᴏʀᴛ", url="https://t.me/XRoiD_Support"),
                 InlineKeyboardButton("🤖 ᴜᴩᴅᴀᴛᴇꜱ", url="https://t.me/XRoiD_BotZ")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ ᴀᴅᴅ ᴍᴇ ᴛᴏ yᴏᴜʀ ᴄʜᴀᴛ ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
